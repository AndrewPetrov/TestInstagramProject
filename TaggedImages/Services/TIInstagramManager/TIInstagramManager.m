...
+ (void)requestRecentPostWithTag:(NSString *)tag
    ...
    dictionaryBlock requestSuccessBlock = ^(NSDictionary *results) {
        TIInstagramPostsPaginationInfo *paginationInfoResult = [TIInstagramMappingManager mapPaginationInfoFromJSONDictionary:results[TIInstagramPaginationKey]];
        [TIInstagramMappingManager mapPostsFromJSONArray:results[TIInstagramDataKey] withRequestedTag:tag];
        [[NSManagedObjectContext MR_defaultContext] MR_saveToPersistentStoreAndWait];
